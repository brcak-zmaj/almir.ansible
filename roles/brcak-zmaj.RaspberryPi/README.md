...
If you're using this role as part of the `brcak-zmaj.almir-ansible` collection:
...
```yaml
roles:
  - role: brcak-zmaj.almir-ansible.raspberry_pi
```
...
This role is part of the `brcak-zmaj.almir-ansible` Ansible collection.
