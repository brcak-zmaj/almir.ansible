...
If you're using this role as part of the `brcak-zmaj.almir_ansible` collection:
...
```yaml
roles:
  - role: brcak-zmaj.almir_ansible.raspberry_pi
```
...
This role is part of the `brcak-zmaj.almir_ansible` Ansible collection.
